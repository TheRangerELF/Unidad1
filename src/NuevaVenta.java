...
public class NuevaVenta implements Initializable {
    ...
    void agregar(ActionEvent event) {
        ...
        int idExistencia = ventaProductoCostos.get(indiceLista).getIdExistencias();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        columnaCostoU.setCellValueFactory(new PropertyValueFactory<>("costoUnitario"));

        TableColumn<AAAAVentaElementos, String> columnaCostoT = new TableColumn<>("Costo Total");
        columnaCostoT.setMinWidth(10);
        columnaCostoT.setCellValueFactory(new PropertyValueFactory<>("costoTotal"));
